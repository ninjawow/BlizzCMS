  ...
  <body>
    ...
    <section class="uk-section uk-section-xsmall">
      <div class="uk-container">
        ...
        <p class="uk-text-center uk-margin-small"><span class="uk-text-bold"><?= $this->config->item('website_name'); ?></span> <i class="far fa-copyright"></i> <?= date('Y'); ?> - <?= $this->lang->line('footer_rights'); ?></p>
        <p class="uk-h6 uk-text-bold uk-text-uppercase uk-margin-small uk-text-center">Powered By <a target="_blank" href="https://wow-cms.com">BlizzCMS</a> & <a target="_blank" href="https://www.azerothcore.org">AzerothCore</a></p>
      </div>
    </section>
  </body>
</html>
